...
class UserCache(Base):
    ...
    # ID совпадает с user.id в Auth Service
    ...
    # Привязка к студии. FK не ставим: studios в той же БД Admin,
    # но FK на users_cache из других таблиц не имеет смысла.
    ...
    __table_args__ = (
        # Индекс для типичных admin-запросов:
        #   - все пользователи определённой роли (фильтр в админке)
        #   - все активные/деактивированные пользователи
        #   - комбинация для dashboard-статистики
        Index(
