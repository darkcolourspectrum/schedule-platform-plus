...
class Settings(BaseSettings):
    """Настройки приложения Profile Service"""
    ...
    database_user: str = Field("profile_user", env="DATABASE_USER")
    database_password: str = Field("profile_password", env="DATABASE_PASSWORD")
    ...
    api_prefix: str = Field("/api/profile", env="API_PREFIX")
    ...
    def get_avatar_url(self, filename: str) -> str:
        ...
        if not filename:
            return None
        return f"{self.base_url}{self.api_prefix}/avatars/files/{filename}"
